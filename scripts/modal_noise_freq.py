...
if CASE == 1:
    FOLDER = "C:/Libraries/Box Sync/ExoLab/Fiber_Characterization/Image Analysis/data/modal_noise/rec_fiber_freq_tests/circular_ag/"
...
if CASE == 2:
    FOLDER = "C:/Libraries/Box Sync/ExoLab/Fiber_Characterization/Image Analysis/data/modal_noise/rec_fiber_freq_tests/"
