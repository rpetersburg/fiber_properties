...
# def filter_image(image, kernel_size, quick=None, cython=False, zero_fill=False, ndimage=False):
#     """
#     Args
#     ----
...
#     if quick:
#         return median_filter(image, kernel_size, mode='nearest')
...
#     return median_filter(image, footprint=mask, mode='nearest')
